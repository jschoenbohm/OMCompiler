...
package CodegenNFXML

import interface NFFlatModelTV;
...
template translateModel(String s/*NFFlatModel flat_model*/)
 "Generates root template for compiling a simulation of a Modelica model."
::=
// match flat_model
// case FLAT_MODEL then
    let() = textFile(s, 'd:\dummy.xml')
